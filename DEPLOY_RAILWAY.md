...
9. Para activar Google Calendar y traer reuniones de Meet, anade:
   - GOOGLE_CLIENT_ID
   - GOOGLE_CLIENT_SECRET
   - GOOGLE_OAUTH_REDIRECT_URI=https://www.doctoralos.com/api/integrations/google-calendar/callback
   - GOOGLE_TOKEN_ENCRYPTION_KEY con una clave larga y privada
10. En Google Cloud Console, registra esa misma redirect URI en tu cliente OAuth.
11. Para activar recuperación de contraseña por email, anade:
   - RESEND_API_KEY
   - EMAIL_FROM
12. Opcionalmente, añade tambien:
   - EMAIL_REPLY_TO
   - EMAIL_SENDER_NAME
   - PASSWORD_RESET_DELIVERY=email
13. Crea un volumen persistente para el servicio.
14. Monta el volumen en /app/data.
15. Espera al despliegue y abre la URL publica.
...
6. Conecta Google Calendar desde `Reuniones y revisión` e importa una reunión de Meet.
7. Comprueba que los datos siguen guardados despues de redeplegar.
